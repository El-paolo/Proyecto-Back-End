	        ...
	        <div class="formulario">
	         ...
	         <!--Completar el Código que se requerirá a continuación--> 	
					...
					if (isset($_POST['actualiza'])) {
						...
						$consulta_stock = "SELECT stock FROM productos WHERE cod_producto= '$seleccionar'";
						$ejecutar_stock = mysqli_query($conexion, $consulta_stock);
						$stock_actual = mysqli_fetch_array($ejecutar);
						$total_stock = $stock_actual['stock'] + $stock;
						$ingreso_stock = "UPDATE productos SET stock = '$total_stock' 
						WHERE cod_producto = '$seleccionar' ";
						$ejecucion_ingreso = mysqli_query($conexion,$ingreso_stock);
