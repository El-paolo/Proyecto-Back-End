        ...
        <div class="contenedor">
            ...
            <?php 
                ...
                if (isset($_POST['agregar'])) {
                    ...
                    $ejecucion_stock = mysqli_query($conexion,$consulta_stock);
                    $resultado_stock = mysqli_fetch_array($ejecucion_stock);
                    $stock_post_entrega = $resultado_stock['stock'] - $cantidad;
                    $stock_actual = "UPDATE productos SET stock = '$stock_post_entrega' 
                    WHERE cod_producto = '$codigo'";
                    $ejecutar_stock_actual = mysqli_query($conexion, $stock_actual);
                    
                    $entrega = "INSERT INTO entregas (rut, cod_producto, cantidad, fecha_entrega)
                    VALUES ('$rut','$codigo','$cantidad', '$fecha')";
                    $ejecutar_entrega =mysqli_query($conexion,$entrega);
